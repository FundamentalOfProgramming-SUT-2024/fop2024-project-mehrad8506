...
int move_player(PLAYER * player , char floor[50][180] , char shown_floor[50][180] , GOLD gold[6] , int * floor_level , ROOM rooms[6] , TRAP trap[3]);
...
int main()
{
    ...
    while(end_program < 4)
    {
        ...
        move_player(&player1 , floor[end_program] , shown_floor[end_program] , gold , &end_program , rooms[end_program] , trap);
//        end_program = 5;
    }
    getch();
    endwin();
...
int move_player(PLAYER * player , char floor[50][180] , char shown_floor[50][180] , GOLD gold[6] , int * floor_level , ROOM rooms[6] , TRAP trap[3])
{
    while(1)
    {
        ...
        shown_floor[player->y_pos][player->x_pos] = '@';
